                ...
                <select className="form-select" aria-label="Default select example">
                    {      
                        ...
                        diseases.data.map(dis => (
                            <option key={dis.disease_id} value={dis.disease_name} onSelect={() => setImpressions(prev => ({
                                ...prev,
                                first: dis.disease_name
                            }))}>{dis.disease_name}</option>
                        ))
                    }
                </select>
            </div>
